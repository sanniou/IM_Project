 ...
 * <pre>
 *     author: Blankj
 *     blog  : https://github.com/Blankj/AndroidUtilCode
 *     time  : 2016/09/21
 *     desc  : Log相关工具类
 * </pre>
 */
    ...
    private static String[] processTagAndHead(String tag) {
        if (!sTagIsSpace && !sLogHeadSwitch) {
            ...
            if (sLogHeadSwitch) {
                ...
                String head = formatter
                        .format("%s, %s(%s.java:%d)", Thread.currentThread().getName(),
                                targetElement.getMethodName(), className,
