...
import com.lib_im.pro.ui.group.GroupActivity;
import com.lib_im.pro.ui.message.SessionActivity;
...
public class MainActivity extends BaseActivity implements View.OnClickListener, IMConnectListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ChatCode.roomMap.size() == 0) {//加入群聊
...
//                            ToastUtils.showShortToast("现在将无法使用聊天相关功能，如需要请重新登录");
//                        }
